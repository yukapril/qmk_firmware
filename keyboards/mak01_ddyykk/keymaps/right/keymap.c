...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT(
    KC_TRNS, KC_TRNS, TO(1), KC_MPLY,
    KC_TRNS, KC_TRNS, KC_BSPC, KC_NLCK,
  ...
  [FUNCTION] = LAYOUT(
  	KC_NO, KC_NO, TO(0), RGB_TOG,
		KC_NO, KC_NO, RGB_HUI, RGB_HUD,
		KC_NO, KC_NO, RGB_SAI, RGB_SAD,
